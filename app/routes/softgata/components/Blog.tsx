    ...
    return (
        <div>
            <div className="t-mt-32 t-p-10 t-bg-gray-200">
                ...
                <div className="container t-flex t-items-baseline t-justify-between">
            ...
            <div className="t-bg-[#2C5850]">
                ...
                <p className="t-text-9xl t-font-extrabold t-text-white pt-6 pl-6">
                ...
                <p className="t-text-9xl t-font-extrabold t-text-white p-6 t-text-right">Blog</p>
