...
export default function Steps() {
    ...
    const selectedArrowRightClasses = "m-4 t-block title is-1 bi bi-arrow-right"
    const selectedTextClasses = "ml-4 lg:t-text-xl t-text-lg"

    const unselectedCircleClasses = "t-bg-gray-300 t-min-w-[90px] t-min-h-[90px] t-rounded-[90px] t-grid t-place-content-center"
    const unselectedArrowRightClasses = "m-4 t-block t-text-gray-400 title is-1 bi bi-arrow-right"
    const unselectedTextClasses = "ml-4 t-text-gray-400 lg:t-text-xl t-text-lg"
